                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="<?= base_url('spk/bibitDel/') . $bit['id_bibit']; ?>" class="badge badge-danger  m-0 p-2" onclick="return confirm('Are you sure delete this data?')">Delete</a>
                                </td>
                            </tr>
                            <!-- Modal Edit -->
                            <div class="modal fade" id="editModalKeg<?= $bit['id_bibit']; ?>" tabindex="-1" role="dialog" aria-labelledby="newRoleLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form method="post" action="<?= base_url('spk/bibitEdit/') . $bit['id_bibit']; ?>">
    ...
    <div class="modal fade" id="newBibit" tabindex="-1" role="dialog" aria-labelledby="newRoleLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="<?= base_url('spk/bibitAdd'); ?>">
                    <div class="modal-body">
                        <div class="form-group">

                ...
                <div class="col-xl-6 mb-4">
                    <div class="card border-left-warning shadow h-200 ml-0">
                        ...
                        <div class="card-footer text-lg">
                            <strong>Hasil Pengawasan dan Penilaian Mingguan ! </strong>
                            ...
                            <div class="card-body">
                                <div id="reportMingguanBlok">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 text-1x scrol mt-2" style="width: 100%; height:100%; font-size:12px;">
                                                    ...
                                                    <small>
                                                        ...
                                                        ?>
                                                            ...
                                                            foreach ($bibitnya as $value) {
                                                                $MguLaluBibit = $this->report->LoadBahanHarianLastBibit($lokasi['id_blok'], $tglmulai, $value['id_bibit']);
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <?php
                                                                foreach ($dates as $tgl) {
                                                                    $realLapTgl = $this->report->LoadLapanganHarianKegBlok($keyl['id_kegiatan'], $tgl, $lokasi['id_blok']);
                                                                    echo "<td class='text-center'>" . $realLapTgl . "</td>";
                                                                    $TotalLapangan = $TotalLapangan + $realLapTgl;
                                                                }

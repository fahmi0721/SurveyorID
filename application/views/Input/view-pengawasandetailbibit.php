...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-10">
            <h1 class="h3 mb-4 text-gray-800 font-weight-bold"><a href="<?= base_url('input/view'); ?>"><?= $title; ?></a> <small class="text-info">/Detail Bibit</small></h1>
        </div>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <div class="modal fade" id="Details<?= $bibit['id_bibit']; ?>" tabindex="-1" role="dialog" aria-labelledby="newRoleLabel" aria-hidden="true">
                                                                    ...
                                                                    <table class="table table-sm">
                                                                        ...
                                                                        foreach ($sql as $val) { ?>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <button type="button" class="btn btn-info p-0" data-toggle="modal" data-target="#fotoView<?= $val['id_harianbibit'] ?>">
                                                                                        <img class="img" src="<?= base_url('assets/'); ?>img/peng-bibit/<?= $val['foto']; ?>" alt="" width="40px" height="40px" title="<?= $val['foto']; ?>">
                                                                                    </button>
                                                                                    <!-- Modal Foto View -->
                                                                                    <div class="modal" id="fotoView<?= $val['id_harianbibit'] ?>" tabindex="-1" aria-labelledby="fotoView<?= $val['id_harianbibit'] ?>Label" aria-hidden="true">
